...
See also [Numerical instabilities](https://github.com/stas00/ml-engineering/blob/master/training/instabilities#numerical-instabilities) in the training chapter, which covers training-level causes and remedies for `inf`/`nan` values.
...
See also [Reproducibility](https://github.com/stas00/ml-engineering/blob/master/training/reproducibility#achieve-determinism-in-randomness-based-software) for achieving determinism across different software and hardware setups.
...
For diagnosing NCCL connectivity problems between GPUs and nodes (the layer below PyTorch), see also [How to diagnose NCCL multi-gpu and multi-node connectivity issues](https://github.com/stas00/ml-engineering/blob/master/network/debug#how-to-diagnose-nccl-multi-gpu-and-multi-node-connectivity-issues).
